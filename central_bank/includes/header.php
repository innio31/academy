...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-header .logo-icon i { font-size: 24px; }
        ...
        .page-title h1 { font-size: 1.5rem; color: var(--dark); margin-bottom: 5px; }
        .page-title p { color: #666; font-size: 0.85rem; }
        .user-info {
            display: flex;
            align-items: center;
            gap: 15px;
        ...
        .badge-active { background: #d5f4e6; color: var(--success); }
        .badge-inactive { background: #fee; color: var(--danger); }
        .modal {
            display: none;
            position: fixed;
            top: 0;
        ...
        @media (max-width: 768px) {
            ...
            .mobile-menu-btn { display: block; position: fixed; top: 15px; right: 15px; z-index: 101; background: var(--primary); color: white; border: none; width: 40px; height: 40px; border-radius: 8px; cursor: pointer; }
        }
