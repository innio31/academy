...
if (!empty($school_logo)) {
    ...
    $logo_paths = [
        $_SERVER['DOCUMENT_ROOT'] . '/eagles/' . $school_logo,
        $_SERVER['DOCUMENT_ROOT'] . '/' . $school_logo,
        $_SERVER['DOCUMENT_ROOT'] . '/eagles/assets/logos/logo.png',
...
<body>
    ...
    $logo_paths_to_try = [
        ...
        '/eagles/admin/assets/logo.png',
        '/eagles/uploads/logo.png',
        '../assets/logos/logo.png',
        'assets/logos/logo.png'
    ];
    ...
    foreach ($logo_paths_to_try as $logo_path) {
        if (!empty($logo_path) && file_exists($_SERVER['DOCUMENT_ROOT'] . $logo_path)) {
            ...
            $logo_displayed = true;
            break;
        } elseif (!empty($logo_path) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/eagles/' . $logo_path)) {
            echo '<img class="rc-logo" src="/eagles/' . htmlspecialchars($logo_path) . '" alt="School Logo" onerror="this.style.display=\'none\'">';
            $logo_displayed = true;
            break;
