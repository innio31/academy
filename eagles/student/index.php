<?php
// eagles/student/index.php - Student Dashboard
session_start();
...
<head>
    ...
    <style>
        * {
        ...
        .nav-item:hover {
            background: <?php echo $sb_hover_bg; ?>;
            color: white;
        }

        .nav-item.active {
            background: <?php echo $sb_active_bg; ?>;
        ...
        <div class="welcome-banner">
            ...
            <div class="welcome-text">
                ...
                <p><i class="fas fa-graduation-cap"></i> <?php echo htmlspecialchars($student_class ?: 'Class not assigned'); ?> |
                    <i class="fas fa-id-card"></i> <?php echo htmlspecialchars($admission_number ?: 'Admission number not set'); ?>
                </p>
            </div>
        </div>
