<?php
// eagles/student/library.php - Online E-Library for Students
session_start();
                        ...
                        <div class="resource-header">
                            ...
                            <div class="resource-details">
                                ...
                                <div class="action-buttons" style="display: flex; gap: 10px; flex-wrap: wrap;">
                                    ...
                                    $file_url = '/eagles/' . $resource['file_path'];
                                    // If the path already starts with /eagles, don't add it again
                                    if (strpos($resource['file_path'], '/eagles/') === 0) {
