    ...
    <script>
        ...
        (function() {
            ...
            function loadNotifications() {
                fetch('/gos/admin/attendance_api.php?action=get_notifications', {
                        headers: {
            ...
            function loadUnreadCount() {
                fetch('/gos/admin/attendance_api.php?action=get_unread_count', {
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        }
                    })
            ...
            function markNotificationRead(id) {
                ...
                fetch('/gos/admin/attendance_api.php', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
