    ...
    switch ($action) {
        ...
        case 'mark_friend':
            ...
            if (isset($_FILES['proof_photo']) && $_FILES['proof_photo']['error'] === UPLOAD_ERR_OK) {
                $upload_dir = $_SERVER['DOCUMENT_ROOT'] . '/gos/uploads/attendance_proofs/';
                ...
                if (function_exists('uploadAndCompressImage')) {
                    ...
                    if (move_uploaded_file($_FILES['proof_photo']['tmp_name'], $target_path)) {
                        $proof_photo = '/gos/uploads/attendance_proofs/' . $filename;
                    }
                }
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <div class="info-text" style="margin-top: 5px;">
                        <i class="fas fa-info-circle"></i> Use the numeric ID, not the staff code (e.g., use "1" not "gos0030")
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    function recordStudentAttendance(studentId) {
        fetch('/gos/staff/attendance_api.php', {
            method: 'POST',
            headers: {
