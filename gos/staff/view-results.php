    ...
    <div class="main-content">
        ...
        <div class="filter-bar">
            <form method="GET" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: flex-end;">
                ...
                <div class="form-group"><label>Exam</label><select name="exam" class="form-select" onchange="this.form.submit()">
                        <option value="">Select Exam</option><?php foreach ($exams as $exam): if ($exam['class'] == $selected_class): ?><option value="<?php echo $exam['id']; ?>" <?php echo $selected_exam == $exam['id'] ? 'selected' : ''; ?>><?php echo htmlspecialchars($exam['exam_name']); ?></option><?php endif;
                                                                                                                                                                                                                                                                                                        endforeach; ?>
                    </select></div>
            </form>
        </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><span class="<?php echo $grade_class; ?>"><?php echo $result['grade'] ?? 'N/A'; ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
        ...
        <?php elseif ($selected_class && $selected_exam): ?>
            <div class="card">
                <p style="text-align:center; padding:30px;">No results found for this exam.</p>
            </div>
        <?php elseif ($selected_class): ?>
            <div class="card">
                <p style="text-align:center; padding:30px;">Select an exam to view results.</p>
            </div>
        <?php else: ?>
            <div class="card">
                <p style="text-align:center; padding:30px;">Select a class to view results.</p>
            </div>
        <?php endif; ?>
    </div>
    <script>
