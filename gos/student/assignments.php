                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <?php if ($assignment['file_path']): ?>
                        <div class="file-attachment" style="margin: 12px 0;">
                            ...
                            <a href="/gos/<?php echo $assignment['file_path']; ?>" target="_blank" style="color: var(--primary-color);">📄 Download Assignment File</a>
                            <a href="/gos/<?php echo $assignment['file_path']; ?>" download class="btn btn-outline btn-sm" style="margin-left: 8px;"><i class="fas fa-download"></i></a>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="submission-detail">
                    ...
                    <?php if ($submission['file_path']): ?>
                        <div class="file-attachment" style="margin-top: 12px;">
                            ...
                            <a href="/gos/<?php echo $submission['file_path']; ?>" target="_blank">View Attachment</a>
                        </div>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="assignment-item">
                            ...
                            <?php if ($task['file_path']): ?>
                                <div class="file-attachment">
                                    <i class="fas fa-paperclip"></i>
                                    <a href="/gos/<?php echo $task['file_path']; ?>" target="_blank">Attachment Available</a>
                                </div>
                            <?php endif; ?>
