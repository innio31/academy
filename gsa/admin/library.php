<?php
// gsa/admin/library.php - Admin Library Management
session_start();
...
<body>
    ...
    <div class="main-content">
        <div class="top-header">
            ...
            <button class="btn" onclick="window.location.href='/gsa/logout.php'"><i class="fas fa-sign-out-alt"></i> Logout</button>
        </div>
