<?php
// gsa/includes/config.php - Portal Configuration with Subscription Check
...
// ============================================
define('SCHOOL_ID', 7);  // Glrious Scholars academy, Ota ID
define('SCHOOL_CODE', 'GSA');

// ============================================
// SCHOOL INFORMATION
// ============================================
define('SCHOOL_NAME', 'Glorious Scholars Academy');
// Logo theme colors for "GLORIOUS SCHOLRS ACADEMY"
define('SCHOOL_PRIMARY', '#4CAF8A');   // Mint/Seafoam Green (shirt)
define('SCHOOL_SECONDARY', '#1B5E20'); // Dark Hunter Green (skirt/trousers & tie)
define('SCHOOL_ACCENT', '#FFFFFF');    // White (shirt collar/accents)
define('SCHOOL_LOGO', 'gsa/assets/logos/logo.png');
define('SCHOOL_MOTTO', 'Excellence and Godliness');
define('SCHOOL_ADDRESS', '24/26, Ijaliye, Ewupe Road, Singer Bus Stop, Sango, Ogun State.');
define('SCHOOL_PHONE', '0802 694 4961');
define('SCHOOL_EMAIL', 'gloriousscholars@gmail.com');
...
function verifySubscription($pdo, $redirect = true)
{
    ...
    if ($subscription_status['should_block']) {
        if ($redirect) {
            ...
            header("Location: /gsa/subscription-expired.php");
            exit();
        }
        return false;
    }
