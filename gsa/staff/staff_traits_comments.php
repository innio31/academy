<?php
// gsa/staff/staff_traits_comments.php - Staff Traits, Comments & Attendance (Only assigned subjects)
session_start();
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .student-items li a:hover {
            background: #f5f6fa;
        }

        .student-items li a.active {
            background: #eef3ff;
            color: var(--primary);
            font-weight: 600;
        }
    ...
    <div class="main-content">
        ...
        <?php if (empty($students)): ?>
            <div class="empty-state"><i class="fas fa-user-graduate"></i>
                <h3>No students in <?php echo htmlspecialchars($class); ?></h3>
            </div>
        <?php else: ?>
