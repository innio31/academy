<?php
// gsa/student/waec-practice.php — Coming Soon page
session_start();
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  h1 span { display: block; font-size: .5em; font-weight: 400; color: var(--muted); -webkit-text-fill-color: var(--muted); }
  ...
  .feature:nth-child(4) { animation-delay: .5s; }
  .feature:nth-child(5) { animation-delay: .6s; }
  .feature:nth-child(6) { animation-delay: .7s; }
  .feature:hover {
  ...
  .feature h3 { font-size: .85rem; font-weight: 600; color: var(--text); }
  .feature p  { font-size: .75rem; color: var(--muted); line-height: 1.5; }

  /* Feature icon colours */
  .fi-1 { background: rgba(251,191,36,.15);  color: var(--gold); }
  .fi-2 { background: rgba(74,222,128,.15);  color: var(--accent); }
  .fi-3 { background: rgba(129,140,248,.15); color: #818cf8; }
  .fi-4 { background: rgba(251,113,133,.15); color: #fb7185; }
  .fi-5 { background: rgba(34,211,238,.15);  color: #22d3ee; }
  .fi-6 { background: rgba(167,243,208,.15); color: #a7f3d0; }
  ...
  .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 32px rgba(26,107,60,.5); }
  .btn-ghost {
