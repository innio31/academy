...
if (!empty($school_logo)) {
    ...
    $logo_paths = [
        $_SERVER['DOCUMENT_ROOT'] . '/ida/' . $school_logo,
        $_SERVER['DOCUMENT_ROOT'] . '/' . $school_logo,
        $_SERVER['DOCUMENT_ROOT'] . '/ida/assets/logos/logo.png',
...
<body>
    ...
    $logo_paths_to_try = [
        ...
        '/ida/admin/assets/logo.png',
        '/ida/uploads/logo.png',
        '../assets/logos/logo.png',
        'assets/logos/logo.png'
    ];
    ...
    foreach ($logo_paths_to_try as $logo_path) {
        if (!empty($logo_path) && file_exists($_SERVER['DOCUMENT_ROOT'] . $logo_path)) {
            ...
            $logo_displayed = true;
            break;
        } elseif (!empty($logo_path) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/ida/' . $logo_path)) {
            echo '<img class="rc-logo" src="/ida/' . htmlspecialchars($logo_path) . '" alt="School Logo" onerror="this.style.display=\'none\'">';
            $logo_displayed = true;
            break;
