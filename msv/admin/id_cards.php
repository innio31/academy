<?php
// msv/admin/id_cards.php - ID Card Generation System
...
<body>
            ...
            <div class="logo">
                <div class="logo-icon">
                    <?php if (!empty($school['logo_path'])): ?>
                        <img src="/msv/assets/logos/logo.png" style="width:100%;height:100%;object-fit:cover;border-radius:6px;" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    ...
    <script>
        const SCHOOL = {
            ...
            logo: '/msv/assets/logos/logo.png',
    ...
    <script>
        ...
        `;
            ...
            students.forEach(s => {
                ...
                const qrSrc = `/msv/uploads/qrcodes/student_${s.id}.png`;
        ...
        // (QR codes are loaded from pre-generated images at /msv/uploads/qrcodes/student_[id].png)
