<?php
// msv/includes/config.php - Portal Configuration with Subscription Check
...
define('SCHOOL_ADDRESS', 'Mighty School for Valours, Ota, Lagos, Nigeria');  // Added back
...
function verifySubscription($pdo, $redirect = true)
{
    ...
    if ($subscription_status['should_block']) {
        if ($redirect) {
            ...
            header("Location: /msv/subscription-expired.php");
            exit();
        }
        return false;
    }
