...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .question-review.correct { border-left: 4px solid var(--accent); }
  .question-review.wrong { border-left: 4px solid #fb7185; }
  .question-header {
    display: flex;
    justify-content: space-between;
    margin-bottom: 12px;
  ...
  .status-correct { background: rgba(74,222,128,.15); color: var(--accent); }
  .status-wrong { background: rgba(251,113,133,.15); color: #fb7185; }
  .question-text {
    margin-bottom: 16px;
    line-height: 1.6;
  }
