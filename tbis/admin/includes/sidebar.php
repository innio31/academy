    ...
    <script>
        ...
        (function() {
            ...
            function loadNotifications() {
                fetch('/tbis/admin/attendance_api.php?action=get_notifications', {
                        headers: {
            ...
            function loadUnreadCount() {
                fetch('/tbis/admin/attendance_api.php?action=get_unread_count', {
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        }
                    })
            ...
            function markNotificationRead(id) {
                ...
                fetch('/tbis/admin/attendance_api.php', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
